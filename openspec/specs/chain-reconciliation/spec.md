...
The system SHALL run a daily scheduled job (3 AM) that queries on-chain ERC-20 balances for all enabled tokens and managed wallets, comparing them against the platform's expected balances.
